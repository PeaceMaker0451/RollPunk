...
{
    internal class DialogFactoryAPI : HeldAPI
    {
        private readonly DialogFactory _dialog;
        
        public DialogFactoryAPI(DialogFactory handler) : base(handler)
        {
            _dialog = handler;
        }
        ...
        public async void showStringDialog(string title, DynValue optionsTable = null, DynValue callback = null, params DynValue[] parameters)
        {
            try
            {
                ...
                var result = await _dialog.ShowStringInput(title, message, placeholder, allowCancel, new Godot.Vector2(minWidth, minHeight), okText, cancelText);
        ...
        public async void showIntDialog(string title, DynValue optionsTable = null, DynValue callback = null, params DynValue[] parameters)
        {
            try
            {
                ...
                var result = await _dialog.ShowIntInput(title, message, defaultValue, minValue, maxValue, step, allowCancel, new Godot.Vector2(minWidth, minHeight), okText, cancelText);
        ...
        public async void showInformationDialog(string title, DynValue optionsTable = null, DynValue callback = null, params DynValue[] parameters)
        {
            try
            {
                ...
                await _dialog.ShowInformation(title, message, new Godot.Vector2(minWidth, minHeight), allowCancel, okText);
        ...
        public async void showConfirmationDialog(string title, DynValue optionsTable = null, DynValue callback = null, params DynValue[] parameters)
        {
            try
            {
                ...
                var result = await _dialog.ShowConfirmation(title, message, allowCancel, new Godot.Vector2(minWidth, minHeight), yesText, noText);
